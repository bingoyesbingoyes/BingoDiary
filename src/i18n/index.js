...
const translations = {
  en: {
    ...
    'sync.enableAutoSync': 'Enable automatic sync',
    'sync.syncInterval': 'Sync interval:',
    'sync.every5min': 'Every 5 minutes',
    'sync.every15min': 'Every 15 minutes',
    'sync.every30min': 'Every 30 minutes',
  ...
  zh: {
    ...
    'sync.enableAutoSync': '启用自动同步',
    'sync.syncInterval': '同步间隔：',
    'sync.every5min': '每 5 分钟',
    'sync.every15min': '每 15 分钟',
    'sync.every30min': '每 30 分钟',
    'sync.everyHour': '每小时',
    'sync.manualSync': '手动同步',
    'sync.lastSync': '上次同步',
